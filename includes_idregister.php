...
if(isset($_POST["action"])) {
    ...
    if($total_row > 0)
    {
        foreach($result as $row)
        {
            $output .= "
            <tr>
            <td style='vertical-align: middle; width: 15.2%;'>" . $row["GID"] .  "</td>
            <td style='vertical-align: middle; width: 15.2%;'>" . $row["name_"] .  "</td>
            <td style='vertical-align: middle; width: 15.3%;'>" . $row["shift_description"] .  "</td>
            <td style='vertical-align: middle; width: 15.3%;'>" . $row["department_name"] .  "</td>
            <td style='vertical-align: middle; width: 10.3%;'>" . $row["building"] .  "</td>";
